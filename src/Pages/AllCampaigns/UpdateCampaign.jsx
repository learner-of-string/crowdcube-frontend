                        ...
                        <div className="flex gap-8">
                            <div className="w-full">
                                ...
                                <Input
                                    ...
                                    required
                                    name="campaignTitle"
                                    defaultValue={currentCampaign?.campaignName}
                                />
                            </div>
                            <div className="w-full">
                                <Label
                        ...
                        <div className="flex gap-8">
                            <div className="w-full">
                                ...
                                <Input
                                    ...
                                    type="number"
                                    name="goalAmount"
                                    defaultValue={currentCampaign?.goalAmount}
                                />
                            </div>
                            <div className="w-full">
                                <Label
                        ...
                        <div className="flex gap-8">
                            <div className="w-full">
                                ...
                                <Input
                                    ...
                                    type="text"
                                    name="location"
                                    defaultValue={currentCampaign?.location}
                                />
                            </div>
                            <div className="w-full">
                                <Label
                                    ...
                                    htmlFor="phoneNumber"
                                >
                                    Contact (if possible provide your whatsapp
                                    number)
                                </Label>
                                <Input
                                    ...
                                    name="phoneNumber"
                                    className="meow"
                                    defaultValue={currentCampaign?.phoneNumber}
                                />
                            </div>
                        </div>
                        <div className="flex gap-8">
                            <div className="w-full">
                                ...
                                <Input
                                    ...
                                    required
                                    name="creatorName"
                                    defaultValue={currentCampaign?.creatorName}
                                />
                            </div>
                            <div className="w-full">
                                <Label
                                ...
                                <Input
                                    ...
                                    required
                                    name="creatorEmail"
                                    defaultValue={currentCampaign?.creatorEmail}
                                />
                            </div>
                        </div>
